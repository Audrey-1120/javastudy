...
public class Class01_String {
  ...
  public static void method15() {
    ...
    System.out.println(String.format("%f", number1)); // 기본적으로 소수점 6자리 이하.
    System.out.println(String.format("%.2f", number1)); // 소수점 이하 2자리
    System.out.println(String.format("%10.2f", number1)); // 전체 10자리, 소수점 이하 2자리
    
    // 정수 형식
    int number2 = 123;
    System.out.println(String.format("%5d", number2));
