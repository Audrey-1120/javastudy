...
public class Class01_String {
  ...
  public static void method3() {
    ...
    // 문자열 객체는 개발자가 관리함 -> 동일한 문자열 객체도 여러 개 생성될 수 있음.
  ...
  public static void method15() {
    ...
    System.out.println(String.format("%f", number1)); // 아무 옵션도 안줌.
    System.out.println(String.format("%.2f", number1)); // 소수점 2자리 맞추세요.
    System.out.println(String.format("%10.2f", number1)); // 전체 자리수 10자리 + 소수점 2자리
